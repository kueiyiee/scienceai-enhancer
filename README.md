...
- Numerical methods rooted in classical texts on numerical analysis
- Inspired by Python scientific computing ecosystem (NumPy, SciPy, Matplotlib)
- Built with [Lovable](https://lovable.dev)

---

<p align="center">
  <strong>⚛️ Built with passion for computational science</strong>
</p>
